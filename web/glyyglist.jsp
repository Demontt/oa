    ...
    <div id="bott1_1" style="width: 1000px;margin-left: 110px;">
  	...
  	<div id="bott4" style="margin-left: 40px;height: 140px;">
  		...
  		<form action="upuser" method="post">
			...
			<table class="subtree1" width="750px;" style="margin-left: auto;margin-right: auto;">
				<tr align="center">
					<td class="td" bgcolor="#63ebfb" width="10%">姓名</td>
					<td class="td" bgcolor="#63ebfb" width="14%">工号</td>
					<td class="td" bgcolor="#63ebfb" width="19%">手机号</td>
					<td class="td" bgcolor="#63ebfb" width="25%">部门</td>
					<td class="td" bgcolor="#63ebfb" width="16%">领导</td>
					<td class="td" bgcolor="#63ebfb" width="16%" style="border-right: thin dashed gray;">操作</td>
				</tr>
				<tr align="center">
					<td class="td">
  	...
  	<div style="margin:0 auto;margin-left:40px;width:910px;height:100px;">
  		...
  		<table class="subtree1" width="650px;" style="margin-left: auto;margin-right: auto;">
			...
			<tr align="center">
				<td class="td" bgcolor="#63ebfb" width="20%">姓名</td>
				<td class="td" bgcolor="#63ebfb" width="30%">手机号</td>
				<td class="td" bgcolor="#63ebfb" width="20%">部门</td>
				<td class="td" bgcolor="#63ebfb" width="16%">领导</td>
				<td class="td" bgcolor="#63ebfb" width="14%" style="border-right: thin dashed gray;">操作</td>
			</tr>
			<tr align="center">
				<td class="td">
