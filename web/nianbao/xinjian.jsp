		...
		function add_t1(a) {
	        ...
	        var new_tr = 
	          $('<tr align="center">'+
	          		'<td class="td">'+num+'</td>'+
	          			'<td class="td">'+
	          				'<textarea name="cdtask" style="resize:none; margin-top: 5px;" rows="1" ></textarea>'+
	          			'</td>'+
	          			'<td class="td">'+
  		...
  		<form action="" method="post" name="form1">
			...
			<table id="subtree1" width="1100px;">
				...
				<tr>
					...
					<td class="td" bgcolor="#63ebfb">年度</td>
					<td class="td" style="border-right: thin dashed gray;">&nbsp;&nbsp;${hb.zyys}年</td>
				</tr>
				<tr>
					<td class="td" bgcolor="#63ebfb">上年度工作重点</td>
						...
						<table class="td_table">
							<tbody id="n">
						  		...
						  		<tr align="center">
						  			...
						  			<td class="td" style="border-right: thin dashed gray;">
										<input name="prerq1" disabled="disabled" class="d4311" value="<s:property value="#info.wcrq"/>" class="Wdate" type="text" onFocus="f1();" style="height: 33px; width:175px; margin-top: 4px; font-size: 21px; "/>
										<div style="display: none;">
											<input name="returnDate" class="d4312" class="Wdate" type="text" onFocus="f2();" style="height: 33px; width:175px; margin-top: 23px; font-size: 21px;"/>
										</div>
									</td>
						  		</tr>
						  		</s:iterator>
				...
				<tr>
					<td class="td" bgcolor="#63ebfb">本年度主要工作总结</td>
					<td class="td" style="border-right: thin dashed gray;" colspan="3">
						<table class="td_table">
							<tbody id="n1">
								<tr align="center">
				...
				<tr>
					<td class="td" bgcolor="#63ebfb">下年度计划工作重点</td>
					<td class="td" style="border-right: thin dashed gray;" colspan="3">
						<table class="td_table">
							<tbody id="n2">
								<tr align="center">
