  		...
  		<form action="" method="post" name="form1">
			...
			<table id="subtree1" width="1100px;">
				...
				<tr>
					...
					<td class="td" style="border-right: thin dashed gray;">&nbsp;&nbsp;${hb.zyys}月</td>
				</tr>
				<tr>
						...
						<table class="td_table">
							<tbody id="n">
						  		...
						  		<tr align="center">
						  			...
						  			<td class="td" style="border-right: thin dashed gray;">
										<input name="prerq1" class="d4311" value="<s:property value="#info.wcrq"/>" class="Wdate" disabled="disabled" type="text" onFocus="f1();" style="height: 33px; width:175px; margin-top: 4px; font-size: 21px; "/>
