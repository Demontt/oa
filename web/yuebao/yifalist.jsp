					...
					<td class="td" style="border-right: thin dashed gray;" align="left">
						<div style="padding-left: 13px;">
							...
							<div style="width:150px; margin: 0 auto;">
								已批阅。
								<a style="color: blue;text-decoration: underline;" href="watch?hb.ty=1&zyy=${info.zyys}">
									查看
								</a>
								&nbsp;&nbsp;
								<a style="color: blue;text-decoration: underline;" href="deleteHB?hb.st=1&zyy=${info.zyys}">
									删除
								</a>
							</div>
							</s:if>
