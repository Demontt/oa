  		...
  		<form action="" method="post">
			<table id="subtree1" width="800px;" style="margin-left: auto;margin-right: auto;">
				<tr align="center">
					...
					<td class="td" bgcolor="#63ebfb" width="15%">周期</td>
					<td class="td" bgcolor="#63ebfb" width="25%">日期</td>
					<td class="td" bgcolor="#63ebfb" width="20%">收件人</td>
					<td class="td" bgcolor="#63ebfb" width="30%" style="border-right: thin dashed gray;">操作</td>
				</tr>
					...
					<td class="td" style="border-right: thin dashed gray;" align="left">
						<div style="padding-left: 13px;">
							...
							<div style="width:150px; margin: 0 auto;">已批阅。
								<a style="color: blue;text-decoration: underline;" href="watch?hb.ty=0&zyy=${info.zyys}">查看</a>&nbsp;&nbsp;<a style="color: blue;text-decoration: underline;" href="deleteHB?hb.st=1&zyy=${info.zyys}">删除</a>
							</div>
							</s:if>
							<s:if test="st==1">
